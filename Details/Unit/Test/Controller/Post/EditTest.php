...
use Employee\Details\Controller\Adminhtml\Post\Edit as EditPage;
...
Class EditTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->editPage = $this->objectManagerHelper->getObject(
            EditPage::class,
            [
                'context' => $context,
    ...
    {
        $this->assertEquals($this->page, $this->editPage->execute());
    }
